const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'aba4f1106a1247c9b88675cf17e9fb36',
  ...
  // 3.14.1
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Welcome to Xponential Investing',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false,
  
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xponential Investing',
  BIO: process.env.NEXT_PUBLIC_BIO || '一Data Driven Investing🍚',
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://clicky.id/xnvesting',
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Investing, Data ',

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xnvest@outlook.co.id',
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/xnvest/',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Xponential Investing', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
